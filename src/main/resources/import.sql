...
INSERT INTO address ("name", contact, email, phone, company, address1, city, postcode, country_code) VALUES ('Sadat', 'K A Sadat', 's1@ftahmed.me', '0987654321', 'GMS Composite Knitting Ind. Ltd.', 'Siddherswari', 'Dhaka', '1200', 'BD');
-- select * from address;
...
WITH v1 AS (SELECT id FROM vendor WHERE vendor_code='213970'), a1 AS (SELECT id FROM address WHERE name='Sadat') INSERT INTO vendor_addresses (vendor_id, address_id) select (table v1), (table a1);
...
-- Invoice address
WITH a1 AS (SELECT id FROM address WHERE name='Sadat') UPDATE vendor SET invoice_address_id = (table a1) WHERE vendor_code='213970';
WITH a1 AS (SELECT id FROM address WHERE name='Sadat') UPDATE vendor SET invoice_address_id = (table a1) WHERE vendor_code='214204';
...
-- Purchase Orders
INSERT INTO purchase_order_details (approval_date, article_number, brand, date_created, delivery_address, factory_name1, last_updated, layout_date, layout_file, order_by, po_number, printer_notes, reject_reason, season, status, total_qty, type, vendor_id, vendor_po) VALUES (NULL, '26861007', '1', '2023-02-20 06:07:56.419673+00', NULL, 'GMS Composite Knitting Ind Ltd', '2023-02-20 06:07:56.419673+00', NULL, NULL, NULL, '400160', NULL, NULL, '231', 'New', 650, 'SMS', '213970', NULL);
-- Purchase Orders Composition
INSERT INTO purchase_order_details_compositions (purchase_order_details_id, compositions) VALUES (1, 'part:Hood');
INSERT INTO purchase_order_details_compositions (purchase_order_details_id, compositions) VALUES (1, 'ci:Cowhide:80%');
INSERT INTO purchase_order_details_compositions (purchase_order_details_id, compositions) VALUES (1, 'ci:Cow Hair:20%');
INSERT INTO purchase_order_details_compositions (purchase_order_details_id, compositions) VALUES (1, 'part:Frontpart');
INSERT INTO purchase_order_details_compositions (purchase_order_details_id, compositions) VALUES (1, 'ci:Cotton:100%');
