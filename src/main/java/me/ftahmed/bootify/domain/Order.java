...
public class Order {
    ...
    // @Column(name="referenceorder", nullable = false, insertable = false, columnDefinition="serial") @CsvIgnore private String referenceorder;
    ...
    @Column(name="pflegehinweis2", columnDefinition = "text") @CsvBindByName(column = "pflegehinweis2") private String additionalWordingsP2;
    @Column(name="pflegehinw01", columnDefinition = "text") @CsvBindByName(column = "pflegehinw01") private String additionalWording01;
    @Column(name="pflegehinw02", columnDefinition = "text") @CsvBindByName(column = "pflegehinw02") private String additionalWording02;
    @Column(name="pflegehinw03", columnDefinition = "text") @CsvBindByName(column = "pflegehinw03") private String additionalWording03;
    @Column(name="pflegehinw04", columnDefinition = "text") @CsvBindByName(column = "pflegehinw04") private String additionalWording04;
    @Column(name="pflegehinw05", columnDefinition = "text") @CsvBindByName(column = "pflegehinw05") private String additionalWording05;
    @Column(name="pflegehinw06", columnDefinition = "text") @CsvBindByName(column = "pflegehinw06") private String additionalWording06;
    @Column(name="pflegehinw07", columnDefinition = "text") @CsvBindByName(column = "pflegehinw07") private String additionalWording07;
    @Column(name="pflegehinw08", columnDefinition = "text") @CsvBindByName(column = "pflegehinw08") private String additionalWording08;
    @Column(name="pflegehinw09", columnDefinition = "text") @CsvBindByName(column = "pflegehinw09") private String additionalWording09;
    @Column(name="pflegehinw10", columnDefinition = "text") @CsvBindByName(column = "pflegehinw10") private String additionalWording10;
    @Column(name="pflegehinw11", columnDefinition = "text") @CsvBindByName(column = "pflegehinw11") private String additionalWording11;
    @Column(name="pflegehinw12", columnDefinition = "text") @CsvBindByName(column = "pflegehinw12") private String additionalWording12;
    @Column(name="pflegehinw13", columnDefinition = "text") @CsvBindByName(column = "pflegehinw13") private String additionalWording13;
    @Column(name="pflegehinw14", columnDefinition = "text") @CsvBindByName(column = "pflegehinw14") private String additionalWording14;
    @Column(name="pflegehinw15", columnDefinition = "text") @CsvBindByName(column = "pflegehinw15") private String additionalWording15;
    @Column(name="pflegehinw16", columnDefinition = "text") @CsvBindByName(column = "pflegehinw16") private String additionalWording16;
    @Column(name="pflegehinw17", columnDefinition = "text") @CsvBindByName(column = "pflegehinw17") private String additionalWording17;
    @Column(name="pflegehinw18", columnDefinition = "text") @CsvBindByName(column = "pflegehinw18") private String additionalWording18;
    @Column(name="pflegehinw19", columnDefinition = "text") @CsvBindByName(column = "pflegehinw19") private String additionalWording19;
    @Column(name="pflegehinw20", columnDefinition = "text") @CsvBindByName(column = "pflegehinw20") private String additionalWording20;
    @Column(name="pflegehinw21", columnDefinition = "text") @CsvBindByName(column = "pflegehinw21") private String additionalWording21;
    @Column(name="pflegehinw22", columnDefinition = "text") @CsvBindByName(column = "pflegehinw22") private String additionalWording22;
    @Column(name="pflegehinw23", columnDefinition = "text") @CsvBindByName(column = "pflegehinw23") private String additionalWording23;
    @Column(name="pflegehinw24", columnDefinition = "text") @CsvBindByName(column = "pflegehinw24") private String additionalWording24;
    @Column(name="pflegehinw25", columnDefinition = "text") @CsvBindByName(column = "pflegehinw25") private String additionalWording25;
    @Column(name="pflegehinw26", columnDefinition = "text") @CsvBindByName(column = "pflegehinw26") private String additionalWording26;
    @Column(name="pflegehinw27", columnDefinition = "text") @CsvBindByName(column = "pflegehinw27") private String additionalWording27;
    ...
    @Column(name="tkgZusatz2", columnDefinition = "text") @CsvBindByName(column = "tkg_zusatz_2") private String animalOriginFiber;
